  ...
  shops: {
    ...
    mercari: {
      make_url: function(brand, category, keywords) {
        ...
        return `https://www.mercari.com/jp/search?keyword=${keywords}&page=1&sort_order=created_desc&${category_params}&brand_name=${brand_name}&brand_id=${brand_id}&size_group=&price_min=&price_max=&status=on_sale`
      },
      brands: {
        any: {
          name: "",
