(import (except (rnrs hashtables) hashtable-ref) (rnrs bytevectors) (sph common) (sph storage dg))
              ...
              (case (first a)
                ( (id alias)
                  (error-let* ((id-new (dg-id-create txn)))
                    (hashtable-set! id-old->new id-old (first id-new))))
                ( (extern)
                ...
                ( (pair)
                  (apply
                    (l (old-left old-right ordinal-left ordinal-right)
                      (let
                        ( (new-left (hashtable-ref id-old->new old-left))
                          (new-right (hashtable-ref id-old->new old-right)))
                  ...
                  (apply
                    (l (old-left old-right new-left new-right)
                      (if (and new-left new-right)
                        ...
                        (relation-part-inexistant old-left old-right new-left new-right)))
                    (append (tail a) (map (l (a) (hashtable-ref id-old->new a)) (tail a)))))))))))))
